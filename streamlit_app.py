...
if final_image is not None:
    ...
    if not models_loaded:
        ...
        try:
            ...
            # 2. الفصل الذكي لتحديد الحالة الصحية بناءً على نوع النبات
            if detected_plant == "ريحان":
                # للريحان: الرقم الصغير (0.16) مصاب، والكبير سليم
                is_healthy = health_value > 0.5
            else:
                # للنعناع: الرقم الكبير (0.90) مصاب، والصغير سليم
                is_healthy = health_value < 0.5
            ...
            if is_healthy:
                ...
                DISEASES_DATABASE = {
                    ...
                    "صدأ الأوراق (Mint Rust)": {
                        ...
                        "chemical": "الرش بمبيدات فطرية يحتوي على مواد مثل (بروكونازول) أو (تيزول) لضمان القضاء على جراثيم الصدأ."
                    }
                }
